...
| -------- |---- | ----- | ------ | ---- |
|Developing a Reliable, General-Purpose Hallucination Detection and Mitigation Service: Insights and Lessons Learned|2024|Song Wang, Xun Wang, Jie Mei, Yujia Xie, Sean Muarray, Zhang Li, Lingfeng Wu, Si-Qing Chen, Wayne Xiong|[link](https://arxiv.org/abs/2407.15441)|Построение системы выявления и устранения галлюцинаций LLM
в задаче суммаризации текста.
Решение для детекции галлюцинаций - ансамбль моделей:
NER (Named Entity Recognition)
NLI (Natural Language Inference)
SBD (Span-based detection) - ключевая для нас часть
GBDT (Gradient Boosting Decision Tree)
Решение для устранения галлюцинаций - повторная генерация ответа на
основе промпта, сформированного от ансамбля моделей-детекторов.|
